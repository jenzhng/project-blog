...
For references for the structure of this project, I came across a blog post [Creating an Escape Room Game in Unity] (https://dev.to/sebight/creating-an-escape-room-game-in-unity-1i9f) for considering the basics of a Unity-based escape room game. Some things to consider are the need for an Inventory UI and different controller scripts for the Player/Camera.
